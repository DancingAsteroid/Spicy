...
public class CircuitComponent : MonoBehaviour
{
    ...
    public double EndOfComponentVoltage { get; protected set; } //Added for Voltmeter
    ...
    //Added for Voltmeter
    public double GetEndOfComponentVoltage()
    {
        return EndOfComponentVoltage;
    }
    //Added for Voltmeter
    public virtual void SetEndOfComponentVoltage(double endOfComponentVoltage)
    {
        EndOfComponentVoltage = endOfComponentVoltage;
    }
    ...
    protected bool IsCurrentSignificant()//Changed: It seams to me that a negative current still is significant, because sometimes the programm might use a diferent way of exploring the circuit then expected...?
    {
        return (Mathf.Abs((float)Current) > SignificantCurrent);
    }
    ...
    public bool GetIsShortCircuit() {//Added for Ammeter
